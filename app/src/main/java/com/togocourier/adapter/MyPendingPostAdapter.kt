 ...
 */
class MyPendingPostAdapter(context: Context?, arrayList: ArrayList<MyPostResponce.UserDataBean>?, click: MyOnClick) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
