...
class WelcomeActivity : AppCompatActivity() {
    ...
    val layouts = intArrayOf(
            R.layout.one_user_side_layout,
            R.layout.two_user_side_layout,
            R.layout.three_user_side_layout,
            R.layout.four_user_side_layout,
            R.layout.five_user_side_layout,
            R.layout.six_user_side_layout,
            R.layout.seven_user_side_layout)
